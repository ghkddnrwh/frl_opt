...
first_args=("gravity" "friction") # Pendulum-v1
    ...
    do
        ...
        do
            ...
            do
                ...
                #     #     --log-folder "logs/tuned_classic_control/PerturbPendulum-v1/${first_arg}/ppo_avg/${second_arg}" \
                ...
                #     #     --log-folder "logs/tuned_classic_control/PerturbPendulum-v1/${first_arg}/fed_ampo_ppo/uniform/${second_arg}/${third_arg}" \
                ...
                #     # python rl_zoo3/train.py --algo fed_ampo_ppo --env PerturbPendulum-v1 \
                #     #     --log-folder "logs/tuned_classic_control/PerturbPendulum-v1/${first_arg}/fed_ampo_ppo/adaptive/${second_arg}/${fourth_arg}" \
                ...
                #     # python rl_zoo3/train.py --algo fed_svrpg_m --env PerturbPendulum-v1 \
                #     #     --log-folder "logs/tuned_classic_control/PerturbPendulum-v1/${first_arg}/fed_svrpg_m/${third_arg}/${fourth_arg}" \
                #     #     --hyperparams n_timesteps:3e6 "perturb_noise_type:\"${first_arg}\"" perturb_noise_range:0.5 local_steps:${second_arg} \
                #     #         n_steps:$(python -c "import math; print(math.ceil($second_arg / 4))") eval_round_freq:$(python -c "import math; print(math.ceil(25000 / 5 / $second_arg))") \
                ...
                #     #     --log-folder "logs/tuned_classic_control/PerturbCartPole-v1/${first_arg}/ppo_avg/${second_arg}" \
                ...
                #     #     --log-folder "logs/tuned_classic_control/PerturbCartPole-v1/${first_arg}/fed_ampo_ppo/uniform/${second_arg}/${third_arg}" \
                ...
                #     # python rl_zoo3/train.py --algo fed_ampo_ppo --env PerturbCartPole-v1 \
                #     #     --log-folder "logs/tuned_classic_control/PerturbCartPole-v1/${first_arg}/fed_ampo_ppo/adaptive/${second_arg}/${fourth_arg}" \
                ...
                #     # python rl_zoo3/train.py --algo fed_svrpg_m --env PerturbCartPole-v1 \
                #     #     --log-folder "logs/tuned_classic_control/PerturbCartPole-v1/${first_arg}/fed_svrpg_m/${third_arg}/${fourth_arg}" \
                #     #     --hyperparams n_timesteps:1e6 "perturb_noise_type:\"${first_arg}\"" perturb_noise_range:0.5 local_steps:${second_arg} \
                #     #         n_steps:$(python -c "import math; print(math.ceil($second_arg / 4))") eval_round_freq:$(python -c "import math; print(math.ceil(25000 / 5 / $second_arg))") \
                #     #         momentum_beta:${third_arg} server_update_weight:${fourth_arg} \
                #     #     --seed $i --frl --log-wandb True --device "cpu" &
                ...
                do
                    ...
                    # python rl_zoo3/train.py --algo fed_ampo_ppo --env PerturbAnt-v4 \
                    #     --log-folder "logs/fed_ampo/tuned_mujoco/revised/PerturbAnt-v4/${first_arg}/fed_ampo_ppo/uniform/${third_arg}" \
                    ...
                    # python rl_zoo3/train.py --algo fed_ampo_ppo --env PerturbAnt-v4 \
                    #     --log-folder "logs/fed_ampo/tuned_mujoco/revised/PerturbAnt-v4/${first_arg}/fed_ampo_ppo/adaptive/${fourth_arg}" \
                    ...
                    #     --log-folder "logs/fed_ampo/tuned_mujoco/revised/PerturbAnt-v4/${first_arg}/fed_ampo_local_ppo/uniform/${third_arg}" \
                    #     --hyperparams 'dual_update_mode:"uniform"' n_timesteps:10e6 "perturb_noise_type:\"${first_arg}\"" perturb_noise_range:0.5 local_steps:${second_arg} \
                    #         n_steps:${second_arg} eval_round_freq:$(python -c "import math; print(math.ceil(25000 / 5 / $second_arg))") \
                    ...
                    # python rl_zoo3/train.py --algo fed_svrpg_m --env PerturbWalker2d-v4 \
                    #     --log-folder "logs/tuning_mujoco_long/revised4/PerturbWalker2d-v4/${first_arg}/fed_svrpg_m/${third_arg}/${fourth_arg}" \
                    #     --hyperparams n_timesteps:10e6 "perturb_noise_type:\"${first_arg}\"" perturb_noise_range:0.5 local_steps:${second_arg} \

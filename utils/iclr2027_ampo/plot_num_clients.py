...
def main():
    ...
    for perturbation_type in perturbation_types:
        ...
        algo_config_list = [
            ...
            ("fed_ampo_ppo", f"logs/fed_ampo/tuned_mujoco/fixed/noise_assignment/{perturbation_type}/3/0.3/fed_ampo_ppo/adaptive/undiscounted/0.0003", "AMPO-PPO(A), N=3"),
            ...
            ("fed_ampo_ppo", f"logs/fed_ampo/tuned_mujoco/fixed/noise_assignment/{perturbation_type}/7/0.3/fed_ampo_ppo/adaptive/undiscounted/0.0003", "AMPO-PPO(A), N=7"),
            ("fed_ampo_ppo", f"logs/fed_ampo/tuned_mujoco/fixed/noise_assignment/{perturbation_type}/9/0.3/fed_ampo_ppo/adaptive/undiscounted/0.0003", "AMPO-PPO(A), N=9"),

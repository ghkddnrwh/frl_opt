...
from rl_zoo3.icml.common.protester import Protester
from stable_baselines3.td3.policies import Actor


class ICMLD3MCPolicy(BasePolicy):
    """
    ...
    def __init__(
        ...
        self.protester_kwargs = self.protester_net_args.copy()        
        ######################################################################################################
...
MlpPolicy = ICMLD3MCPolicy


class CnnPolicy(ICMLD3MCPolicy):
    """
    Policy class (with both actor and critic) for TD3.
...
class MultiInputPolicy(ICMLD3MCPolicy):
    """

...
from rl_zoo3.icml.icml_d3mc.policies import ICMLD3MCPolicy
from rl_zoo3.icml.icml_d3mc.icml_d3mc import ICMLD3MC

SelfICMLD2MC = TypeVar("SelfICMLD2MC", bound="ICMLD2MC")


class ICMLD2MC(ICMLD3MC):
    """
    ...
    def __init__(
        self,
        policy: Union[str, Type[ICMLD3MCPolicy]],
        ...
        super().__init__(
            ...
            expectile_level = expectile_level,
            #################################################################################

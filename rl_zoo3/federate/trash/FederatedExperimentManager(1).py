...
class FederatedExperimentManager(ExperimentManager):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.perturbation_metadata_path: str | None = None
    ...
    def _save_perturbation_metadata(self) -> None:
        self.perturbation_metadata_path = os.path.join(self.save_path, "perturbations.json")
        payload = {
            ...
            "client_noise_values": [float(v) for v in self.client_noise_values],
            "clients": [
                {
                    "client_id": idx,
    ...
    def _init_eval_history(self) -> None:
        ...
        self.eval_history = {
            ...
            "client_ids": np.arange(self.num_clients, dtype=np.int32),
            "local_mean": [],
            "local_std": [],
            "nominal_mean": [],
            "nominal_std": [],
    ...
    def _save_eval_npz(self) -> None:
        ...
        payload = {
            ...
            "client_ids": np.asarray(self.eval_history["client_ids"], dtype=np.int32),
    ...
    def setup_experiment(self) -> tuple[BaseAlgorithm, dict[str, Any]] | None:
        ...
        self.perturb_noise_range = float(hyperparams.pop("perturb_noise_range", 0.0))

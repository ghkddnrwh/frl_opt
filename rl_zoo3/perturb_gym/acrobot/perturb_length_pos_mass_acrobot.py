...
# class PerturbLengthPosMassAcrobotEnv(Env):
#     """
#     ## Description
...
#         noise_range = self.LINK_LENGTH_1 * rate

#         noise = random.uniform(-noise_range, noise_range)
#         # noise2 = random.uniform(-noise_range, noise_range)

#         print("Noise Rate : ", rate)
#         # print("Noise2 Rate : ", rate)
    
#         print("Noise : ", noise)
#         # print("Noise2 : ", noise2)

#         # 노이즈가 추가된 중력 값 (항상 0보다 큼)
#         self.LINK_LENGTH_1 = max(0, self.LINK_LENGTH_1 + noise)
#         self.LINK_LENGTH_2 = max(0, self.LINK_LENGTH_2 + noise)

#         self.LINK_MASS_1 = max(0, self.LINK_MASS_1 + noise)
#         self.LINK_MASS_2 = max(0, self.LINK_MASS_2 + noise)

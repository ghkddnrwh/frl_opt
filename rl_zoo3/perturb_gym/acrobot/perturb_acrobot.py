...
class PerturbAcrobotEnv(Env):
    ...
    def __init__(self, render_mode: Optional[str] = None, noise_type=None, noise=0):
        ##############################################################################################################
        ...
        print("LINK_LENGTH_1:", self.LINK_LENGTH_1)
        print("LINK_LENGTH_2:", self.LINK_LENGTH_2)
        print("LINK_MASS_1:", self.LINK_MASS_1)
        print("LINK_MASS_2:", self.LINK_MASS_2)
        print("LINK_COM_POS_1:", self.LINK_COM_POS_1)
        print("LINK_COM_POS_2:", self.LINK_COM_POS_2)
        ##############################################################################################################
    ...
    def _terminal(self):
        ...
        return bool(-self.LINK_LENGTH_1 * cos(s[0]) - self.LINK_LENGTH_2 * cos(s[1] + s[0]) > (self.LINK_LENGTH_1 + self.LINK_LENGTH_2) / 2)
        ##############################################################################################################

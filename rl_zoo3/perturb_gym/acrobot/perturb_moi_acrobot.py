...
# class PerturbMoiAcrobotEnv(Env):
#     """
#     ## Description
...
#     LINK_MOI1 = 1.0  #: moments of inertia for both links
#     LINK_MOI2 = 1.0  #: moments of inertia for both links
...
#         noise_range = self.LINK_MOI2 * rate
...
#         self.LINK_MOI1 = max(0, self.LINK_MOI1 + noise)
#         self.LINK_MOI2 = max(0, self.LINK_MOI2 + noise)
#         ##############################################################################################################

...
# class PerturbPosAcrobotEnv(Env):
#     """
#     ## Description
...
#         noise_range = self.LINK_COM_POS_1 * rate
...
#         self.LINK_COM_POS_1 = max(0, self.LINK_COM_POS_1 + noise)
#         self.LINK_COM_POS_2 = max(0, self.LINK_COM_POS_2 + noise)
#         ##############################################################################################################

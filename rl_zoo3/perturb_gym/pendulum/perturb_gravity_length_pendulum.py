...
# class PerturbGravityLengthPendulumEnv(gym.Env):
#     """
#     ## Description
...
#         length_noise_range = self.l * rate

#         length_noise = random.uniform(-length_noise_range, length_noise_range)

#         print("Length Noise : ", length_noise)

#         # 노이즈가 추가된 중력 값 (항상 0보다 큼)
#         self.g = max(0, self.g + gravity_noise)
#         self.l = max(0, self.l + length_noise)
#         ##############################################################################################################

...
class PerturbPendulumEnv(gym.Env):
    """
    ## Description
    ...
    * v0: Initial versions release
    ...
    def __init__(self, render_mode: Optional[str] = None, g=10.0, noise_type=None, noise: Union[float, List[float]] = 0.0):
        self.max_speed = 8
        self.max_torque = 2.0
        self.dt = 0.05
        self.g = g

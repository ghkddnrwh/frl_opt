...
# class PerturbGravityMassPendulumEnv(gym.Env):
#     """
#     ## Description
...
#         self.l = 1.0
#         ##############################################################################################################
#         # 정규 분포에서 노이즈 생성 (평균: 0, 표준편차: 1)
#         rate = 0.9

#         gravity_noise_range = self.g * rate

#         gravity_noise = random.uniform(-gravity_noise_range, gravity_noise_range)
    
#         print("Noise Rate : ", rate)
    
#         print("Gravity Noise : ", gravity_noise)

#         mass_noise_range = self.m * rate

#         mass_noise = random.uniform(-mass_noise_range, mass_noise_range)

#         print("Mass Noise : ", mass_noise)

#         # 노이즈가 추가된 중력 값 (항상 0보다 큼)
#         self.g = max(0, self.g + gravity_noise)
#         self.m = max(0, self.m + mass_noise)
#         ##############################################################################################################

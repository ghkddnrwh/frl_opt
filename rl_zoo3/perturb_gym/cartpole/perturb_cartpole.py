...
class PerturbCartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    """
    ## Description
    ...
    * v0: Initial versions release.
    ...
    def __init__(
        self, sutton_barto_reward: bool = False, render_mode: Optional[str] = None, noise_type=None, noise: Union[float, List[float]] = 0.0,
    ):

...
# class PerturbMassCartCartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
#     """
#     ## Description
...
#         min_noise = -noise_rate * self.masscart
#         max_noise = noise_rate * self.masscart
...
#         self.masscart = max(0.01, self.masscart + noise)
#         ##############################################################################################################
#         self.masspole = 0.1

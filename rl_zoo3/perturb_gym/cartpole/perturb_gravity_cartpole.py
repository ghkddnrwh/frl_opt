...
# class PerturbGravityCartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
#     """
#     ## Description
...
#         min_noise = -noise_rate * self.gravity
#         max_noise = noise_rate * self.gravity
...
#         self.gravity = max(0, self.gravity + noise)
#         ##############################################################################################################
#         self.masscart = 1.0
#         self.masspole = 0.1

...
# class PerturbForceMagCartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
#     """
#     ## Description
...
#         min_noise = -noise_rate * self.force_mag
#         max_noise = noise_rate * self.force_mag
...
#         self.force_mag = max(0, self.force_mag + noise)
#         ##############################################################################################################

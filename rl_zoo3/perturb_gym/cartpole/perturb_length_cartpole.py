...
# class PerturbLengthCartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
#     """
#     ## Description
...
#         min_noise = -noise_rate * self.length
#         max_noise = noise_rate * self.length
...
#         self.length = max(0, self.length + noise)
#         ##############################################################################################################

...
#     manager_cls = TD3AvgExperimentManager if args.algo == "td3_avg" else ExperimentManager

#     exp_manager = manager_cls(
#         args,
#         args.algo,
#         env_id,
#         args.log_folder,
...
def train() -> None:
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Use the federated RL experiment manager instead of the default single-agent manager",
    )
    parser.add_argument(
        "-tags", "--wandb-tags", type=str, default=[], nargs="+", help="Tags for wandb run, e.g.: -tags optimized pr-123"
    )
    ...
    manager_cls = FederatedExperimentManager if args.frl else ExperimentManager
